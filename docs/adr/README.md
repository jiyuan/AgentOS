...
| [0005](0005-SAFETY_EVENTS.md) | Safety decisions are immutable append-only events; a deletion is never the record of an outcome | M6 |
| [0006](0006-CLEAR_EPOCH.md) | `/clear` writes an epoch marker; irreversible purge is a distinct authorized operation | M6 |
